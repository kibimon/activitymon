...
A <dfn>capsule capture</dfn> is an attempt to [`mon:Capture`] a [`mon:Mon`] by use of a special [`mon:Item`], of type [`mon:Capsule`].
...
##  4. The `mon:Capsule` Item  {#Capsule}

URI
: `https://www.monstr.pub/ns/monstrpub#Capsule`
...
Properties
: Inherits all properties from [`mon:Item`]
...
##  5. Determining Capsule Success  {#success}
